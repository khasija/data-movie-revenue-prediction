...
class Advancedprocessing:   
    ...
    def process(df, list_top_30=[], train_set=True):
        ...
        top_30_vars = ['director_name', 'producer_name', 'production_companies', 'production_countries'] #'actor1_name', 
        if train_set:
        ...
        col_list = [ 'genres', 'title', 'actor1_name', 'actor2_name', 'actor3_name', 'actor4_name', 'director_gender',
                    'actor5_name', 'director_name', 'producer_name', 'screeplay_name', 'actor1_gender', 'actor2_gender','actor3_gender','actor4_gender','actor5_gender',
                    'editor_name', 'production_companies', 'production_countries', 'release_month', 'budget', 'spoken_languages_number',
                    'original_language',  'release_date', 'release_year', 'release_week','original_title','overview','tagline',
                    'release_weekday', 'id'] # 
